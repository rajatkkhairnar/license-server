Create a dark mode hero section for The MicroLab(main name of the system is Laxio, so use Laxio) with the following exact specifications:
...
- "Start Free Trial" button: white background, black text, rounded-full, px-5 py-2.5, font-semibold [this will connect to our Trial Key sign up form " https://license-server-orcin-seven.vercel.app/ "]
...
**Pre-headline:**
- Text: "Built for Speed. Designed for Simplicity."
...
**Subheadline:**
- Text: "The lightweight, offline-ready CRM built for modern labs. Automate data analysis and manage workflows with intuitive, effortless dashboards."
...
- Background: white
- Text: "Start Free Trial" (font-medium, text-lg, Instrument Sans, color #0a0400) [this will connect to our Trial Key sign up form " https://license-server-orcin-seven.vercel.app/ "]
